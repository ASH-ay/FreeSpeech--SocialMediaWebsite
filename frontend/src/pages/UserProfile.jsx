  ...
  return (
    <section className="profile">
      <div className="container profile__container">
        <Link to={`/myposts/${currentUser.id}`} className='btn'>Review Posts</Link>
        <div className="profile__details">
          <div className="avatar__wrapper">
            ...
            {isAvatarTouched && <button className='profile__avatar-btn' onClick={changeAvatarHandler}><IoMdCheckmarkCircleOutline /></button>}
          </div>
